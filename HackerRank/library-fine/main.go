// hackerrank.com/challenges/library-fine/problem
...
func libraryFine(d1 int32, m1 int32, y1 int32, d2 int32, m2 int32, y2 int32) int32 {
	...
	var dayFine int32 = 15
	var monthFine int32 = 500
	var yearFine int32 = 10000

	if y2 < y1 {
		return yearFine
	} else if y2 == y1 && m2 < m1 {
		return monthFine * (m1 - m2)
	} else if y2 == y1 && m2 == m1 && d2 < d1 {
		return dayFine * (d1 - d2)
	} else {
		return 0
	}
}
