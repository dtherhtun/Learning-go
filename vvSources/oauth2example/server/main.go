...
func main() {
	...
	srv.SetPasswordAuthorizationHandler(func(ctx context.Context, clientID, username, password string) (userID string, err error) {
		fmt.Println("I'm SetPasswordAuthorizationHandler")
	...
	//	fmt.Println("I'm /oauth/authorize")
	//	if dumpvar {
...
//	fmt.Println("I'm SetUserAuthorizationHandler")
//	if dumpvar {
